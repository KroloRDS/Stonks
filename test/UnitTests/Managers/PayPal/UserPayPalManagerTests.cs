...
using Stonks.Managers.PayPal;

namespace UnitTests.Managers.PayPal;

[TestFixture]
public class UserPayPalManagerTests : ManagerTest
{
	private readonly UserPayPalManager _manager;
	private const string CorrectEmail = "test@test.com";

	public UserPayPalManagerTests()
	{
		_manager = new UserPayPalManager(_ctx);
	}
